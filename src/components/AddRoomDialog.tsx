...
//             ownerId: loggedInUser ? loggedInUser.userId : null,
//         };
...
//                 </DialogHeader>
//                 <form ref={formRef} onSubmit={handleSubmit} className="space-y-4 overflow-scroll">
//                     <div>
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-h-[90vh] overflow-scroll mx-auto p-6 rounded-lg bg-white shadow-lg">
                <DialogHeader>
                    <DialogTitle className="text-2xl font-semibold text-gray-900">Add Room</DialogTitle>
                </DialogHeader>
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center space-x-4">
                        <label className="flex items-center text-sm font-medium text-gray-700">
                            Available
                            <input type="checkbox" name="available" defaultChecked className="p-1 ml-2 h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                        </label>
                        <label className="flex items-center text-sm font-medium text-gray-700">
                            Accessible
                            <input type="checkbox" name="accessible" defaultChecked className="p-1 ml-2 h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                        </label>
                        <label className="flex items-center text-sm font-medium text-gray-700">
                            Public
                            <input type="checkbox" name="isPublic" defaultChecked className="p-1 ml-2 h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                        </label>
                    </div>
