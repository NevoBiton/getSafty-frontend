        ...
        <ScrollArea>
          <DrawerContent className="overflow-scroll h-[55%] w-full mx-auto px-4  rounded-t-lg bg-white shadow-lg transition-all duration-300 ease-in-out fixed bottom-0">
            ...
            <DrawerDescription className="py-2">
              ...
              <p className="text-gray-700 text-[17px] font-semibold my-2">
                {room.description}
              </p>

              <div className="flex justify-between">
                <div>
                  <h4 className="text-[17px] font-semibold">Address:</h4>
                  <p className="text-[17px]">{`${room.address.street}, ${room.address.city}`}</p>
                  <p className="text-[17px]">{`Floor: ${
                    room.address.floor || "1"
                  }`}</p>
                  <p className="text-[17px]">{`Apartment: ${
                    room.address.appartment || "0"
                  }`}</p>
                </div>
                <div className="text-right">
                  <h4 className="text-[17px] font-semibold">Capacity:</h4>
              ...
              <div className="flex justify-between mt-2">
                <div className="flex items-center gap-1">
                  <h4 className="text-[17px] font-semibold">Open:</h4>
                  {room.available ? (
                ...
                <div className="flex items-center gap-1">
                  <h4 className="text-[17px] font-semibold">Public:</h4>
                  {room.isPublic ? (
                    <IoMdCheckmark className="text-green-600 text-lg" />
                  ) : (
                    <FaTimes className="text-red-600 text-lg" />
